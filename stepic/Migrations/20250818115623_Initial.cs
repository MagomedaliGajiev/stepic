        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    epic_count = table.Column<int>(type: "int", nullable: false),
                    abuse_count = table.Column<int>(type: "int", nullable: false),
                    ReplyCommentId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_comments", x => x.id);
                    table.ForeignKey(
                        name: "FK_comments_comments_ReplyCommentId1",
                        column: x => x.ReplyCommentId1,
                        principalTable: "comments",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_comments_steps_reply_comment_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_comments_ReplyCommentId1",
                table: "comments",
                column: "ReplyCommentId1");
